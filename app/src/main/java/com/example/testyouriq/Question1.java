...
public class Question1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MyCounter myCounter = new MyCounter(1000 * (i * 60) + j * 1000, 1000L);
		myCounter.start();
		this.timer1 = myCounter;
		...
		QuesData.initializeArray();
		int num = QuesData.array[0];
		...
		if(keyCode==KeyEvent.KEYCODE_BACK)
		{
			...
			builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int id) {
					Toast.makeText(Question1.this, "Youe test has been canceled!", 1).show();
					timer1.cancel();
					finish();
				}
	...
	public class MyCounter extends CountDownTimer{
		...
		public void onFinish(){
			timer1.cancel();
			startActivity(new  Intent(Question1.this,ResultActivity.class));
			finish();
		}
