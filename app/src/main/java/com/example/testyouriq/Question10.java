...
public class Question10 extends Activity {
	...
	public void submitTest(View view){
		...
		builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int id) {
				Toast.makeText(Question10.this, "Youe test submitted successfully!", 1).show();
				startActivity(new  Intent(Question10.this,ResultActivity.class));
				timer1.cancel();
				finish();
			}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if(keyCode==KeyEvent.KEYCODE_BACK)
		{
			...
			builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int id) {
					Toast.makeText(Question10.this, "Youe test has been canceled!", 1).show();
					timer1.cancel();
					finish();
				}
			}).setNegativeButton("No", new DialogInterface.OnClickListener() {
