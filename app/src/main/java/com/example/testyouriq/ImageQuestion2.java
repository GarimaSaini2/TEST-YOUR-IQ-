...
public class ImageQuestion2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_image_question2);
		...
		if(DbInfo.age>=15 && DbInfo.age<=18  ){
			imageView.setImageResource(R.raw.bw15_18_second);
		}else if(DbInfo.age>=19 && DbInfo.age<=22  ){
			imageView.setImageResource(R.raw.bw19_22_second);
		}else if(DbInfo.age>=23 && DbInfo.age<=28 ){
			imageView.setImageResource(R.raw.bw23_28_second);
		}else if(DbInfo.age>=29 && DbInfo.age<=39  ){
			imageView.setImageResource(R.raw.bw29_39_second);
		}else if(DbInfo.age>=40 ){
			imageView.setImageResource(R.raw.above40_second);
		}
	}
		...
		if(keyCode==KeyEvent.KEYCODE_BACK)
		{
			...
			builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int id) {
					Toast.makeText(ImageQuestion2.this, "Youe test has been canceled!", 1).show();
					timer1.cancel();
					finish();
				}
	...
	public class MyCounter extends CountDownTimer{
		...
		public void onFinish(){
			timer1.cancel();
			startActivity(new  Intent(ImageQuestion2.this,ResultActivity.class));
			finish();
		}
