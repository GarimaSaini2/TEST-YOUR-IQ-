...
public class Question3 extends Activity {
	...
	public void next(View view){
		...
		Intent intent = new Intent(this, ImageQuestion1.class);
		...
		if(keyCode==KeyEvent.KEYCODE_BACK)
		{
			...
			builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int id) {
					Toast.makeText(Question3.this, "Youe test has been canceled!", 1).show();
					timer1.cancel();
					finish();
				}
	...
	public class MyCounter extends CountDownTimer{
		...
		public void onFinish(){
			timer1.cancel();
			startActivity(new  Intent(Question3.this,ResultActivity.class));
			finish();
		}
